...
PLATFORM_FACEBOOK_ACCOUNT = "https://www.facebook.com/@МООК-в-КазНУ-ималь-Фараби-215732095885005"
PLATFORM_TWITTER_ACCOUNT = "@KazNU_official"
...
FEATURES = {
    ...
    'ENABLE_VIDEO_BEACON': True,

    # enable beacons for lms onload event statistics
    'ENABLE_ONLOAD_BEACON': True,
    ...
    #'COURSE_DISCOVERY_FILTERS' = ["language"]
...
TIME_ZONE = 'Asia/Almaty'  # http://en.wikipedia.org/wiki/List_of_tz_zones_by_name
...
LANGUAGES = (
    ...
    ('Kazakh', u'қазақ тілі (Қазақстан)'),  # Kazakh (Kazakhstan)
